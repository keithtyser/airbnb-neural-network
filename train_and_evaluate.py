...
def main(args):
    ...
    X_test, _ = load_and_preprocess_data(model, split="val")

    print("-------------training model------------")
    model.train(X_train, y_train)

    print("-------------evaluating model------------")
    score = evaluate(model, X_test, _)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train and evaluate model for housing data")

    # main parameters
    parser.add_argument("--train_data", type=str,
                        default="../Data", help="Train dataset folder path")
    parser.add_argument("--test_data", type=str,
                        default="../Data", help="Test dataset folder path")
    parser.add_argument("--output_dir", type=str,
                        default="../results", help="Results output path")
    parser.add_argument("--seed", type=int, default=42, help="Random seed")
    parser.add_argument("--bu_id", type=str, default="0000",
                        help="Last four digit of student's BU ID")
